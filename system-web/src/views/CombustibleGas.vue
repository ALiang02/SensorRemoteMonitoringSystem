  ...
  methods: {
    ...
    getNodes() {
      ...
      return this.$axios({
        ...
        for (let i = 0; i < this.combustibleGas_data.sensors.length; i++) {
          this.legend_data[i] =
            this.combustibleGas_data.sensors[i] + "号传感器";
          this.series_data[i] = {
            ...
            symbol: "none",
            // areaStyle: {},
            data: this.combustibleGas_data.values[i],
            markArea: {
              itemStyle: {
    ...
    pie_draw() {
      this.pie_chart = echarts.init(
        document.getElementById("combustibleGas_pie")
      );
    ...
    table_draw() {
      ...
      this.line_chart = echarts.init(document.getElementById("combustibleGas"));
      // 绘制图表
